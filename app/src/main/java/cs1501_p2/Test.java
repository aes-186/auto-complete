/**
 * A test driver for CS1501 Project 2
 * @author	Dr. Farnan
 */
package cs1501_p2;
...
public class Test {
	public static void main(String[] args) {
		String eng_dict_fname = "app/src/main/resources/dictionary.txt";
		String uhist_state_fname = "app/src/main/resources/uhist_state.p2";

		AutoCompleter ac;

        //dictionary should be initialized to all the words in dictionary 
		...
		if (check.exists()) {
			...
			ac = new AutoCompleter(eng_dict_fname); // no user history file
		}
